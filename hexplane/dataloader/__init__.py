...
from .XMPIDataset import XMPIDataset
...
def get_train_dataset(cfg, is_stack=False):
    ...
    elif cfg.data.dataset_name == "XMPIDataset":
        train_dataset = XMPIDataset(
            cfg.data.datadir,
            cfg.data.idx,
            cfg.data.num_angles,
            "train",
            ...
            N_random_pose=cfg.data.N_random_pose,
            size = cfg.data.size,
            n_trianing_angles = cfg.data.nta
        )
    else:
