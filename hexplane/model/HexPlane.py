...
class HexPlane(HexPlane_Base):
    ...
    def init_planes(self, res, device):
        ...
        # We use density_basis_mat to project extracted features from HexPlane to density_dim
        # density_basis_mat are linear layers, whose input dims are calculated based on the fusion methods.
